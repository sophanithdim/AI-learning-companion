...
// Get all companions with optional filtering by subject or topic
...
/**
 * Retrieve a single companion by its ID.
 *
 * @param {string} id - The ID of the companion to retrieve.
 * @returns {Promise<Companion | null>} The companion if found, otherwise null.
 */
